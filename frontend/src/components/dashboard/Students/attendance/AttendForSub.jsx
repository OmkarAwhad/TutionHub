	...
	return (
		<div className="space-y-4">
			...
			<div className="block md:hidden px-4">
				{subjects.map((sub) => {
					const stats =
						attendanceData[sub._id]?.statistics || {};
					return (
						<div
							key={sub._id}
							className="bg-white p-4 rounded-lg shadow divide-y divide-light-gray"
						>
							<h3 className="text-base font-semibold text-charcoal-gray mb-2">
								{sub.name}
							</h3>
