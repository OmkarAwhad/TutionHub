...
function EnhancedDownloader({
	...
	const renderSubmissionStatus = () => {
      return (
         <div
            className={`text-gray-700 text-sm font-medium py-1 px-2 rounded mb-2 ${
               isLate ? "bg-red-200" : "bg-green-600"
            }`}
         >
	...
	const buttonClasses =
		className ||
		`${baseClasses} ${sizeClasses} ${stateClasses[downloadState]}`;
