         ...
         <div className="mb-8">
            <div className="relative max-w-2xl mx-auto">
               ...
               <input
                  ...
                  className="block w-full pl-14 pr-6 py-4 text-lg bg-white border-2 border-light-gray rounded-2xl shadow-lg focus:outline-none focus:ring-2 focus:ring-charcoal-gray/20 focus:border-charcoal-gray transition-all duration-300 hover:shadow-xl hover:border-medium-gray placeholder-medium-gray"
               />
               {searchTerm && (
                  <button
                                          ...
                                          >
                                             <label className="inline-flex items-center justify-center cursor-pointer">
                                                <input
                                                   ...
                                                   className="form-radio h-4 w-4 text-charcoal-gray border-charcoal-gray focus:ring-charcoal-gray focus:ring-offset-0 focus:ring-2 focus:ring-opacity-50"
                                                />
                                             </label>
                                          </td>
                                       )
