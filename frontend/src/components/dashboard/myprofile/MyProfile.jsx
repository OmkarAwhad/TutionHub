	...
	const getRoleIcon = () => {
		switch (user.role) {
			case ACCOUNT_TYPE.STUDENT:
				return (
					<PiStudentFill className="text-2xl sm:text-3xl md:text-4xl" />
				);
			case ACCOUNT_TYPE.TUTOR:
				return (
					<GiTeacher className="text-2xl sm:text-3xl md:text-4xl" />
				);
			case ACCOUNT_TYPE.ADMIN:
				return (
					<RiAdminLine className="text-2xl sm:text-3xl md:text-4xl" />
				);
			default:
				return (
		...
		<div className="p-4 sm:p-6">
			<div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
				...
				<div className="flex items-center gap-3 mb-6 sm:mb-8">
					<FaUser className="text-charcoal-gray text-xl sm:text-2xl" />
					...
					{isEditing ? (
						...
						<div className="p-4 sm:p-6 md:p-8">
							<div className="flex items-center gap-3 mb-4 sm:mb-6">
								<RiEdit2Fill className="text-charcoal-gray text-lg sm:text-xl" />
							...
							>
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
									...
									<div>
										...
										<input
											...
											className="w-full px-3 py-2 sm:px-4 sm:py-3 border border-light-gray rounded-lg text-charcoal-gray focus:outline-none focus:border-charcoal-gray transition-colors duration-200 text-sm sm:text-base"
										/>
									</div>
								...
								<div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 pt-4 sm:pt-6">
									<button
										type="submit"
										disabled={loading}
										className={`w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 sm:px-6 sm:py-3 font-medium rounded-lg transition-colors duration-200 text-sm sm:text-base ${
											loading
									...
									<button
										...
										className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-light-gray text-charcoal-gray font-medium rounded-lg hover:bg-slate-gray hover:text-white transition-colors duration-200 text-sm sm:text-base"
									>
						...
						<div className="p-4 sm:p-6 md:p-8">
							<div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 md:gap-8">
								...
								<div className="flex-shrink-0 mx-auto sm:mx-0">
									<div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-charcoal-gray flex items-center justify-center text-white shadow-lg">
										{getRoleIcon()}
									</div>
								</div>
								...
								<div className="flex-1 w-full">
									<div className="flex flex-col items-center sm:items-start sm:flex-row sm:justify-between gap-4">
										<div className="text-center sm:text-left">
											<h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-charcoal-gray mb-2">
												{user.name}
											</h2>
											<div className="flex items-center justify-center sm:justify-start gap-2 mb-3 sm:mb-4">
												...
												<span className="text-sm sm:text-base text-medium-gray break-all">
													{user.email}
												</span>
											</div>
											<div
										...
										<div className="flex flex-col w-full sm:w-auto sm:flex-row gap-2 sm:gap-3">
											<button
												...
												className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-charcoal-gray text-white font-medium rounded-lg hover:bg-medium-gray transition-colors duration-200 text-sm"
											>
											...
											<button
												...
												className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-medium-gray text-white font-medium rounded-lg hover:bg-charcoal-gray transition-colors duration-200 text-sm"
											>
									...
									<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-6 sm:mt-8">
										{/* Phone */}
										<div className="p-3 sm:p-4 bg-light-gray rounded-lg">
											...
											<p className="text-sm sm:text-base text-charcoal-gray font-semibold pl-0 sm:pl-6">
												{user?.profile
													?.phoneNumber || (
													<span className="text-slate-gray text-xs sm:text-sm italic">
														Not
														provided
													</span>
												)}
					...
					<div className="bg-white rounded-lg shadow-md border border-light-gray p-4 sm:p-6 md:p-8">
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
							<NavLink
								...
								className="p-4 sm:p-6 bg-charcoal-gray text-white text-center font-semibold text-sm sm:text-lg rounded-lg hover:bg-medium-gray transition-colors duration-200 hover:shadow-lg"
							>
								View Attendance
							</NavLink>
							<NavLink
				...
				{/* Danger Zone */}
				<div className="bg-white rounded-lg shadow-md border border-red-200 p-4 sm:p-6 md:p-8">
					<div className="flex items-center gap-3 mb-4 sm:mb-6">
						<FiAlertTriangle className="text-red-500 text-xl sm:text-2xl" />
						<h3 className="text-lg sm:text-xl font-bold text-charcoal-gray">
							Danger Zone
						</h3>
					</div>
					<div className="bg-red-50 rounded-lg p-4 sm:p-6 border border-red-200">
						<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
							<div>
								<h4 className="text-base sm:text-lg font-semibold text-charcoal-gray mb-2">
									Delete Account
								</h4>
								<p className="text-slate-gray text-xs sm:text-sm mb-1">
							...
							<button
								...
								className="flex items-center justify-center gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors duration-200 text-sm sm:text-base"
							>
